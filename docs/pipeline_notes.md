...
- Missing `tissue`, `tissue.name`, and `oncotree.mainType` values are backfilled from other rows for the same patient. Remaining blanks are treated as build failures.
